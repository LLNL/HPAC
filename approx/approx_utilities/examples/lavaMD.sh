...
python ./benchmark.py -b -i build/lavaMD.yaml -t "approx_space/$exp_size/approximate_techniques.yaml" -r $repeat -n 1,16,32  
python analysis_scripts/concatenate.py analysis_results/ lavaMD 
