...
python ./benchmark.py -b -i build/CFD.yaml -t "approx_space/$exp_size/approximate_techniques.yaml" -r $repeat -n 1,16,32  
python analysis_scripts/concatenate.py analysis_results/ CFD

if [ "$visualize" == true ]; then
  python analysis_scripts/viz_CFD.py analysis_results/CFD.pkl
fi
